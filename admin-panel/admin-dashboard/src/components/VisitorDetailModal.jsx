            ...
            <>
              <div className="flex flex-col items-center gap-3">
                ...
                <button
                  ...
                  className="mt-1 flex w-full items-center justify-center gap-1.5 rounded-lg px-4 py-2.5 text-xs font-semibold text-white shadow-sm transition disabled:opacity-50 sm:w-auto sm:py-2"
